...
import com.bazzar.android.presentation.destinations.ForgetPasswordScreenDestination
...
fun LoginScreen(
    ...
    viewModel.sideEffect { effect ->
        when (effect) {
            ...
            is LoginContract.Effect.Navigation.GoToForgetPassword ->
                navigator.navigate(ForgetPasswordScreenDestination(effect.mobileNumber))
        }
    }
    // init logic
